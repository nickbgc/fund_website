...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Blockchain Global Capital</title>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          An investment vehicle for high net worth individuals focused around Bitcoin and Blockchain related technologies and infrastucture.
        </p>
